...
pub fn run_gpu_bmm(
    ...
    struct MatmulInfo { b: u32, m: u32, k: u32, n: u32 }
    ...
    // The tiled shader uses a workgroup size of 16x16.
    // We launch a 3D grid of workgroups to cover the batch dimension as well.
