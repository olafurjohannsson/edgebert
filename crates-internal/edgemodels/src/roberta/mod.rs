//! RoBERTa/MPNet bi-encoder implementation
...
pub struct RobertaBiEncoder {
    base_encoder: TransformerEncoder,
    tokenizer: Tokenizer,
}

impl RobertaBiEncoder {
    ...
    pub async fn encode(&self, texts: Vec<&str>, normalize: bool) -> Result<Vec<Vec<f32>>> {
        ...
        let encoder_output = self.base_encoder.forward(&input_ids, &attention_mask).await?;
